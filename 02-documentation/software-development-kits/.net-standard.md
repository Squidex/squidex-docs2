...
<figure><img src="../../.gitbook/assets/image.png" alt=""><figcaption><p>The sample code for the client manager</p></figcaption></figure>
...
<pre class="language-csharp"><code class="lang-csharp">services.AddSquidexClient(options =>
{
    options.AppName = "...";
